...
class image_converter:
  ...
  def __init__(self):
    self.image_pub = rospy.Publisher("/image_processing_bw/bin_img",Image, queue_size=1)

    self.bridge = CvBridge()
    self.image_sub = rospy.Subscriber("/image_processing_gray/bin_img",Image,self.callback, queue_size=1)
